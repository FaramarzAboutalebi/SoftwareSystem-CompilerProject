...
/*
  Switch statement handling all error logs.
  int typeOfError: error code representing the type of error to log.
*/
...
/*
    Create two arrays to store the tokens and identfiers:
